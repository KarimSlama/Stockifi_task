...
class CreateDishPage extends StatefulWidget {
  ...
  @override
  CreateDishPageState createState() => CreateDishPageState();
}

class CreateDishPageState extends State<CreateDishPage>
  ...
  void initState() {
    ...
    final dishesUIProvider = context.read<DishesUIProvider>();

    _nameController.text = dishesUIProvider.name!;
    _sizeController.text =
        (dishesUIProvider.size == null) ? '' : dishesUIProvider.size.toString();
    _searchController.text = dishesUIProvider.ingredientQuery;
    _selectedUnit = dishesUIProvider.selectedUnit;
    _ingredients = {...dishesUIProvider.ingredients};
    _units = dishesUIProvider.units;
    ...
    if (widget.recipe != null) {
      ...
      if (mounted && saveRecipeWithLessSize) {
        final result = await context
            ...
            .updateRecipe(recipe)
            .whenComplete(() {
          context.read<DishesUIProvider>().resetRecipe();
          resetForm();
  ...
  void onTap(String itemId) {
    ...
    context.read<DishesUIProvider>().putIngredient(itemId);
    context.read<DishesUIProvider>().ingredientQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    final query = context.select<DishesUIProvider, String>(
        (DishesUIProvider dishesUIProvider) =>
            dishesUIProvider.ingredientQuery);
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            onChanged: (value) {
              context.read<DishesUIProvider>().name = value;
            },
            onSubmitted: (_) {
          ...
          TextField(
              ...
              onChanged: (value) {
                context.read<DishesUIProvider>().size = value;
              },
          ...
          Column(
            children: [
              TextField(
                ...
                onChanged: (value) {
                  context.read<DishesUIProvider>().ingredientQuery = value;
          ...
          SizedBox(
            ...
            child: StockifiButton.async(
              onPressed: () {
                setState(() {
                  isFormValid = _nameController.text.trim().isNotEmpty &&
                      _sizeController.text.trim().isNotEmpty &&
                      _selectedUnit != null &&
                      _ingredients.isNotEmpty &&
                      !_ingredients.values.contains(0);
